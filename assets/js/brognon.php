                        ...
                        <div class="col-md-8 mt-5">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-4">
                                        <input type="email" required class="form-control" placeholder="Prénom ">
                                    </div>
                                    <div class="col-md-6 mt-4">
                                        <input type="text" class="form-control" required placeholder="Password">
                                    </div><div class="col-md-6 mt-4">
                                        <input type="text" class="form-control" required placeholder="Password">
                                    </div> </div><div class="col-md-6 mt-4">
                                        <input type="text" class="form-control" required placeholder="Password">
                                    </div>
                                   
                                </div>
                                <div class="card-footer">
                                    <a class="btn btn-primary btn-lg" href=" mot_de_passe_oublier.php" class="btn bnt-outilne-primary btn-lg"> Déconnexion</a>
                                </div>
                            </div>
                        </div>
                    </div>
